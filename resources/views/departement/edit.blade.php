                        ...
                        <form method="POST" action="{{ route('departements.update', $departement->id) }}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text"
                                    name="name" placeholder="input departement name" value="{{ $departement->name }}" >
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="" cols="30"
                                    rows="3">{{ $departement->description }}</textarea>
                            </div>
...
<script>
    ...
    // SET VALUE SELECT 2
    $("#e1").val([
        @foreach ($departement->privileges->all() as $privilege_selected)
