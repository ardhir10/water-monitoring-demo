            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('alarm.store') }}">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control{{ $errors->has('sensor') ? ' is-invalid' : '' }}"
                                            ...
                                            <option value="{{$sensor->tag_name}}">{{$sensor->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="">SP</label>
                                         <input type="number"  class="form-control{{ $errors->has('sp') ? ' is-invalid' : '' }}" name="sp">
                                         @if ($errors->has('sp'))
