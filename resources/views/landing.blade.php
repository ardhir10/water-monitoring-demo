...
<head>
    ...
    {{-- <meta name="twitter:image" content="{{ asset('backend/') }}/{{ asset('backend/') }}/{{ asset('backend/') }}/img/bracketplus-social.png">
    --}}
    ...
    {{-- <meta property="og:image" content="{{ asset('backend/') }}/{{ asset('backend/') }}/{{ asset('backend/') }}/img/bracketplus-social.png">
    --}}
    {{-- <meta property="og:image:secure_url" content="{{ asset('backend/') }}/{{ asset('backend/') }}/{{ asset('backend/') }}/img/bracketplus-social.png">
    --}}
