                ...
                <div class="br-section-wrapper rounded-20" style="padding: 30px 20px">
                    <div style="align">
                        <span class="tx-bold tx-18"><i class="icon ion ion-ios-cog-outline tx-22"></i>
                            {{$page_title}}</span>
                        <a href="{{url('settings/maintenance/create') }}">
                        ...
                        <table class="table display responsive nowrap" id="datatable1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$maintenance->sensors->sensor_display}}</td>
                                    <td>{{$maintenance->value}}</td>
                                    <td>{!!$maintenance->status()!!}</td>
                                    <td>
                                        <a href="{{url('settings/maintenance/'.$maintenance->id.'/edit/') }}">
                                            <button class="btn btn-warning btn-sm text-white">
                                                <i class="icon icon ion ion-edit"></i> Edit
                                            </button>
                                        </a>
                                        <button class="btn btn-danger btn-sm text-white"
                                            onclick="deleteData({{$maintenance->id}})">
