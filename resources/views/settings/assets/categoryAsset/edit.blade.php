                        ...
                        <form method="POST" action="{{ route('category.update',$categorys->id) }}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text"
                                    name="name" placeholder="input departement name" value="{{ $categorys->name }}" >
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="" cols="30"
                                    rows="3">{{ $categorys->description }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn   btn-success" type="submit"><i class="far fa-save"></i>
                                    Save</button>
                                <a href="{{ url('asset/category') }}"><button class="btn   btn-danger" type="button"><i
