                        ...
                        <form method="POST" action="{{ route('material.update',$materials->id) }}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text"
                                    name="name" placeholder="input Material Name" value="{{ $materials->name }}" >
                                @if ($errors->has('name'))
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-6">
                                    <div class="form-group  " id="datepicker-date-area">
                                        ...
                                        <input type="text" name="purchase_at" id="purchase_at"  value="{{date('d-m-Y', strtotime( $materials->purchase_at)) }}" autocomplete="off" class="datepicker form-control time" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control{{ $errors->has('purchase_price') ? ' is-invalid' : '' }}" type="number" name="purchase_price"placeholder="input category purchase_price" value="{{ $materials->purchase_price }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control{{ $errors->has('type_id') ? ' is-invalid' : '' }}" name="type_id" id="">
                                    <option value="" hidden>-Pilih Type-</option>

                                    @foreach ($types as $type)
                                    <option value="{{$type->id}}"
                                        {{ (old('type_id') ?? $materials->type_id)== $type->id ? 'selected': '' }}>
                                        {{$type->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="" cols="30" rows="3">{{ $materials->description }}</textarea>
                            </div>
