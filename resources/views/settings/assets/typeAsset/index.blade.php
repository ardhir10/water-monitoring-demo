            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper rounded-20 animated fadeInUp" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <a href="{{url('settings/asset/type/create') }}">
                        ...
                        <table class="table display responsive nowrap" id="datatable1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>
                                        <img class="wd-70 img-profile"
                                            src="{{asset('backend/images/type/'.$type->image)}}" alt="profile">
                                    </td>
                                    <td>{{ $type->name }}</td>
                                    <td>{{ Illuminate\Support\Str::limit($type->description, 60, '...') }}</td>
                                    <td>
                                        <a href="{{url('settings/asset/type/'.$type->id.'/edit/') }}">
