                    ...
                    <div style="align">
                        ...
                        <form method="POST" action="{{ route('bom.update',$boms->id) }}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('bom_name') ? ' is-invalid' : '' }}" type="text"
                                    name="bom_name" placeholder="input Bom Name" value="{{ $boms->bom_name }}" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="" cols="30"
                                    rows="3">{{ $boms->description }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn   btn-success" type="submit"><i class="far fa-save"></i>
                                    Save</button>
                                <a href="{{ url('asset/bom') }}"><button class="btn btn-danger" type="button"><i
...
<script>
    ...
    // SET VALUE SELECT 2
    $("#e1").val([
        @foreach ($boms->materials->all() as $privilege_selected)
