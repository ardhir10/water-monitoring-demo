            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper rounded-20 animated fadeInUp" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('location.update',$locations->id) }}">
                            @csrf
                            @method('PUT')
                            @if ($errors->any())
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}"
                                    type="text" name="country" placeholder="input Country" value="{{ $locations->country }}">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" type="text"
                                    name="city" placeholder="input City" value="{{ $locations->city }}">
                                @if ($errors->has('city'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control" id="" cols="30"
                                    rows="3">{{ $locations->address }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ url('settings/asset/location') }}"><button class="btn   btn-danger" type="button"><i class="far fa-arrow-alt-circle-left"></i> Cancel</button></a>
                            </div>
                        </form>
                    </div>
                    <hr>
