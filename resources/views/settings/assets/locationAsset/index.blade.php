            ...
            <div class="col-lg-12 mg-b-20">
                <div class="br-section-wrapper rounded-20 " style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <a href="{{url('settings/asset/location/create') }}">
                        ...
                        <table class="table display responsive nowrap" id="datatable1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $location->city }}</td>
                                    <td>{{  Illuminate\Support\Str::limit($location->address, 70, '...') }}</td>
                                    <td>
                                        <a href="{{url('settings/asset/location/'.$location->id.'/edit/') }}">
                                            <button class="btn btn-warning btn-sm text-white">
                                                <i class="icon icon ion ion-edit"></i> Edit

                                            </button>
                                        </a>
                                        <a href="{{url('settings/asset/location/detail/'.$location->id) }}">
...
<script>
    ...
    var route_url= 'location';
    var table = $('#datatable1').DataTable();
    function detailLocations(id) {
        $.confirm({
            title: 'Detail Locations',
            theme : 'material',
            backgroundDismiss: true, // this will just close the modal
            content: 'url:settings/asset/location/'+id,
