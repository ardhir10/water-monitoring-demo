            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper rounded-20" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('privilege.update',$privilege->id) }}"
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text"
                                    ...
                                    type="text" name="name" placeholder="input name" value="{{old('name') ?? $privilege->name}}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group ">
                                ...
                                <textarea name="description" class="form-control" rows="5"  placeholder="input description">{{old('description') ?? $privilege->description}}</textarea>
                            </div>
